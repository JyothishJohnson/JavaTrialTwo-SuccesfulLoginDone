...
public class MoreOnClasses extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                String moreClasses = "moreClasses";
                String message = "You Clicked Position" + position + clickedItem.getmTopicName();
                Toast.makeText(MoreOnClasses.this, message, Toast.LENGTH_SHORT).show();
                switch (position){
                    case 0:  Intent i0 = new Intent(MoreOnClasses.this, Explain.class);
                        i0.putExtra("clickedItem",clickedItem.getmTopicName());
                        i0.putExtra("position",position);
                        i0.putExtra("basic",moreClasses);
                        startActivity(i0);
                        break;
                    case 1:  Intent i1 = new Intent(MoreOnClasses.this, Explain.class);
                        i1.putExtra("clickedItem",clickedItem.getmTopicName());
                        i1.putExtra("position",position);
                        i1.putExtra("basic",moreClasses);
                        startActivity(i1);
                        break;
                    case 2:  Intent i2 = new Intent(MoreOnClasses.this, Explain.class);
                        i2.putExtra("clickedItem",clickedItem.getmTopicName());
                        i2.putExtra("position",position);
                        i2.putExtra("basic",moreClasses);
                        startActivity(i2);
                        break;
                    case 3:  Intent i3 = new Intent(MoreOnClasses.this, Explain.class);
                        i3.putExtra("clickedItem",clickedItem.getmTopicName());
                        i3.putExtra("position",position);
                        i3.putExtra("basic",moreClasses);
                        startActivity(i3);
                        break;
                    case 4:  Intent i4 = new Intent(MoreOnClasses.this, Explain.class);
                        i4.putExtra("clickedItem",clickedItem.getmTopicName());
                        i4.putExtra("position",position);
                        i4.putExtra("basic",moreClasses);
                        startActivity(i4);
                        break;
                    case 5:  Intent i5 = new Intent(MoreOnClasses.this, Explain.class);
                        i5.putExtra("clickedItem",clickedItem.getmTopicName());
                        i5.putExtra("position",position);
                        i5.putExtra("basic",moreClasses);
                        startActivity(i5);
                        break;
                    case 6:  Intent i6 = new Intent(MoreOnClasses.this, Explain.class);
                        i6.putExtra("clickedItem",clickedItem.getmTopicName());
                        i6.putExtra("position",position);
                        i6.putExtra("basic",moreClasses);
                        startActivity(i6);
                        break;
                    case 7:  Intent i7 = new Intent(MoreOnClasses.this, Explain.class);
                        i7.putExtra("clickedItem",clickedItem.getmTopicName());
                        i7.putExtra("position",position);
                        i7.putExtra("basic",moreClasses);
                        startActivity(i7);
                        break;
                    case 8:  Intent i8 = new Intent(MoreOnClasses.this, Explain.class);
                        i8.putExtra("clickedItem",clickedItem.getmTopicName());
                        i8.putExtra("position",position);
                        i8.putExtra("basic",moreClasses);
                        startActivity(i8);
                        break;
                    case 9:  Intent i9 = new Intent(MoreOnClasses.this, Explain.class);
                        i9.putExtra("clickedItem",clickedItem.getmTopicName());
                        i9.putExtra("position",position);
                        i9.putExtra("basic",moreClasses);
                        startActivity(i9);
                        break;
        ...
        fab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent basicConceptsIntent = new Intent(MoreOnClasses.this, ForumActivity.class);
